...
import manage.test.RetryCountOnFailure;
...
public class RetryAnalyzer implements IRetryAnalyzer {
    ...
    public boolean retry(ITestResult result) {
        ...
        RetryCountOnFailure annotation = result.getMethod().getConstructorOrMethod().getMethod()
                .getAnnotation(RetryCountOnFailure.class);
